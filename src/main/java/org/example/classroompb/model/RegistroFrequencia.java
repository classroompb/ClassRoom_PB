 ...
 *
 * <p>Cada instância representa a chamada de um único aluno em um único dia. O professor marca
 * {@code presente = true} (presença) ou {@code presente = false} (falta). A chave lógica é a tripla
 * (turma, aluno, data) — não há dois registros para o mesmo aluno na mesma turma e data.
 */
