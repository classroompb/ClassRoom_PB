 ...
 *
 * <p>Segue o mesmo padrão de {@link TurmaRepository}: serialização de objetos
 * para um arquivo {@code .dat} na pasta {@code dados/}. Métodos sobrescrevíveis
 * para permitir repositórios fake em testes.
 */
