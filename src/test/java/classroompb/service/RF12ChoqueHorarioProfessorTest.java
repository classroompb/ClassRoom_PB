...
class RF12ChoqueHorarioProfessorTest {
	...
	void devePermitirTurmasSemChoqueDeHorarioParaProfessor() {
		...
		assertDoesNotThrow(() -> {
			...
			turmaService.ofertarTurma("CC102", "P001", periodo, 30, "10:00-12:00", "Sala A2");
		});
	}
	...
	void deveImpedirChoqueDeHorarioParaMesmoProfessor() {
		...
		Exception ex = assertThrows(IllegalArgumentException.class, () ->
			turmaService.ofertarTurma("CC102", "P001", periodo, 30, "09:00-11:00", "Sala A2")
		);
		assertTrue(ex.getMessage().toLowerCase().contains("professor") && ex.getMessage().toLowerCase().contains("horário"));
	}
