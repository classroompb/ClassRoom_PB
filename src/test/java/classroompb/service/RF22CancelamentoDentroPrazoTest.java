...
class RF22CancelamentoDentroPrazoTest {
    ...
    void devePermitirCancelamentoDentroDoPrazo() {
        // Arrange
        Turma turma = turmaService.ofertarTurma("CC101", "P001", periodoAtivo, 2, "08:00-10:00", "Sala A1");
    ...
    void devePermitirCancelamentoNoUltimoDiaDoPrazo() {
        ...
        LocalDate hoje = LocalDate.now();
        PeriodoLetivo periodoHoje = new PeriodoLetivo("2026.2", hoje.minusDays(7), hoje.plusDays(60), hoje);
        periodoHoje.ativar();

        Turma turma = turmaService.ofertarTurma("CC101", "P001", periodoHoje, 2, "08:00-10:00", "Sala A1");
        turmaService.solicitarMatricula(turma.getCodigo(), "A001");
    ...
    void deveRejeitarCancelamentoForaDoPrazo() {
        ...
        LocalDate hoje = LocalDate.now();
        PeriodoLetivo periodoVencido = new PeriodoLetivo("2026.2", hoje.minusDays(30), hoje.plusDays(30), hoje.minusDays(1));
        periodoVencido.ativar();

        Turma turma = turmaService.ofertarTurma("CC101", "P001", periodoVencido, 2, "08:00-10:00", "Sala A1");
        turmaService.solicitarMatricula(turma.getCodigo(), "A001");
    ...
    void devePermitirCancelamentoSemLimiteDePrazo() {
        ...
        Turma turma = turmaService.ofertarTurma("CC101", "P001", periodoSemLimite, 2, "08:00-10:00", "Sala A1");
        turmaService.solicitarMatricula(turma.getCodigo(), "A001");
    ...
    void devePromoterDaFilaAosCancelarDentroDoPrazo() {
        ...
        Turma turma = turmaService.ofertarTurma("CC101", "P001", periodoAtivo, 1, "08:00-10:00", "Sala A1");
        turmaService.solicitarMatricula(turma.getCodigo(), "A001");
    ...
    void deveRespeitarPeriodoAtivo() {
        ...
        LocalDate hoje = LocalDate.now();
        PeriodoLetivo periodoInativo = new PeriodoLetivo("2026.4", hoje.minusDays(7), hoje.plusDays(60), hoje.plusDays(7));
        // Não ativar - deixar inativo

        Turma turma = turmaService.ofertarTurma("CC101", "P001", periodoInativo, 2, "08:00-10:00", "Sala A1");
        turmaService.solicitarMatricula(turma.getCodigo(), "A001");
