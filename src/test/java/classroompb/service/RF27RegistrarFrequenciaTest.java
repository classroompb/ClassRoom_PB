...
class RF27RegistrarFrequenciaTest {
    ...
    void deveRegistrarPresencaDeAlunoMatriculado() {
        RegistroFrequencia registro = frequenciaService.registrarPresenca(turma.getCodigo(), "A001", dia1);
    ...
    void deveRegistrarFaltaDeAlunoMatriculado() {
        RegistroFrequencia registro = frequenciaService.registrarFalta(turma.getCodigo(), "A001", dia1);
    ...
    void devePersistirRegistrosEntreInstancias() {
        ...
        FrequenciaService recarregado = new FrequenciaService(frequenciaRepo, usuarioService, turmaService);
